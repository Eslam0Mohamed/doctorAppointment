...
const Navbar = () => {
    return (
        <div className='fixed right-0 left-0 top-2'>
            <div className="container shadow-2xl rounded-xl w-10/12 mx-auto px-2 bg-blue-100">

                <nav className='flex justify-between align-items-center py-5'>
