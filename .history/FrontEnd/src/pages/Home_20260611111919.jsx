...
const Home = () => {
  return (
    <>
      ...
      rgba(2,132,199,0.15)),url(${bg})`}} className='bg-cover bg-no-repeat bg-center min-h-screen'>
        <div className='h-screen content max-w-4xl mx-auto flex gap-2 flex-col items-center justify-center'>
          ...
          <div className="flex gap-4">
            <Link to={"/appointments"} className='duration-300 hover:text-main hover:bg-tertiary  px-8 py-2 rounded-md bg-main text-white font-semibold '>Book an appointment</Link>
            <Link to={"/doctors"} className='btn'>Book an appointment</Link>
