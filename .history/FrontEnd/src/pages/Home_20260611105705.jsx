    ...
    <>
      ...
      rgba(2,132,199,0.1)),url(${bg})`}} className='bg-cover bg-no-repeat bg-center min-h-screen'>
        <div className='h-screen content flex gap-3 flex-col items-center justify-center'>
          ...
          <p className='text-secondry max-w-[600px] text-2xl font-semibold '>Experience world-class medical services with state-of-the-art technology and compassionate care tailored to your unique health needs.</p>
          <div>
