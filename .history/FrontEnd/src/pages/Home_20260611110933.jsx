    ...
    <>
      ...
      rgba(2,132,199,0.1)),url(${bg})`}} className='bg-cover bg-no-repeat bg-center min-h-screen'>
        <div className='h-screen content flex gap-2 flex-col items-center justify-center'>
          ...
          <p className='text-black-200 text-2xl font-semibold max-w-7xl text-center'>Experience world-class medical services with state-of-the-art technology and compassionate care tailored to your unique health needs.</p>
          <div>
