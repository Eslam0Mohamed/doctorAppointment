      ...
      rgba(2,132,199,0.15)),url(${bg})`}} className='bg-cover bg-no-repeat bg-center min-h-screen'>
        <div className='h-screen content max-w-4xl mx-auto flex gap-2 flex-col items-center justify-center'>
          ...
          <div>
            ...
            <Link to={"/V"} className='block hover:scale-105 hover:transition-all mt-6 hover:duration-300 hover:text-main hover:bg-tertiary  px-8 py-2 rounded-md bg-main text-white font-semibold '>Book an appointment</Link>
